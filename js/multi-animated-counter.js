$(function () {
    ...
    */
    ...
    let counterClass = '.counter-heading';
        ...
        $(className).animate({
            ...
            step: function (now) {
                if (direction == 'reverse') {
                    ...
                    $(".counter1 .counter-text h2")[0].textContent = parseInt($(".counter1 .counter-text h2")[0].textContent).toFixed(0)
                    $(".counter3 .counter-text h2")[0].textContent = parseInt($(".counter3 .counter-text h2")[0].textContent).toFixed(0)
                }
            },
            complete: doCount
        });
